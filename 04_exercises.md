...
**The zoom level essentially determines the level of detail displayed on the map (the higher the zoom level, the greater the detail shown).**
...
```
## Source : http://tile.stamen.com/toner/10/244/367.png
```
...
```
## Source : http://tile.stamen.com/toner/10/244/368.png
```
...
```
## Source : http://tile.stamen.com/toner/10/244/369.png
```
...
```r
ggmap(twin) +
  annotate(geom = "text", x = -93.33, y = 44.933, label = "Macalester College", color = "darkblue") +
  annotate(geom = "point", x = -93.1693, y = 44.9378, size = 3, color = "darkblue") +
  theme_map()
```
